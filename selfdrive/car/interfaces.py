...
class CarInterfaceBase():
  ...
  def create_common_events(self, cs_out, extra_gears=None, gas_resume_speed=-1, pcm_enable=True):
    ...
    if (cs_out.brakePressed and (not self.CS.out.brakePressed or not cs_out.standstill)):#(cs_out.gasPressed and (not self.CS.out.gasPressed) and cs_out.vEgo > gas_resume_speed) or \
